...
namespace ApiKeyAuth.Filters
{
    public class AuthorizeMultiplePolicyFilter : IAsyncAuthorizationFilter
    {
        ...
        {
            var filters = context.ActionDescriptor.AttributeRouteInfo;
            if (context.Filters.Any(item => item is IAllowAnonymousFilter)) // TODO Fix AllowAnnonymous
            {
                return;
            }
        ...
        class Repo
        {
            ...
            List<ApiKey> allKeys => configuration.GetSection("Keys").GetSection("List").Get<List<ApiKey>>();
